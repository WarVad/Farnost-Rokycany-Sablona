		...
		<footer class="footer">
			<div class="footer-wrapper">
				<div class="footer-wrapper-odkazy">
						<a href="https://www.instagram.com/farnostrokycany/">
						...
						<a href="https://www.facebook.com/farnostRokycany">
							<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
				...
				<div class="footer-wrapper-inf">
						...
						<div class="footer-wrapper-inf-kontakt">
							<h2>Kontakty</h2>
							<div class="footer-wrapper-inf-kontakt-container">
								<div class="footer-wrapper-inf-kontakt-container-popisek">
									<h3> Římskokatolická farnost Rokycany</h3>
									<ul>
										<li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
											...
											Nám. Josefa Urbana 52, 337 01 Rokycany 1
										</li>
										<li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
